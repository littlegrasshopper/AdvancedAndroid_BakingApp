...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(getIntent().hasExtra(GAME_FINISHED)){
            ...
            BakingAppWidgetService.startActionUpdateBakingWidget(this, 11,"Nutella Pie YUMM", yourScoreText);
    ...
    public void newGame(View view) {
        Intent quizIntent = new Intent(this, com.example.android.bakingapp.QuizActivity.class);
